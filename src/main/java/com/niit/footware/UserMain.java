...
public class UserMain {
	...
	case 1:
		...
		user1.setUserLocation(sc.next());
		System.out.println("UserAge:");

		user1.setUserAge(sc.nextInt());
		System.out.println("UserGender:");

		user1.setUserGender(sc.next());
	...
	case 2:
		...
		for(User user : userList1)
		{
			...
			System.out.print("Age:"+user.getUserAge()+"|");
			System.out.print("Location:"+user.getUserLocation()+"|");
			System.out.print("Gender:"+user.getUserGender()+"");
