...
public class ProductMain {
	...
	public void productOut()
	{
		...
		product.setProductName(sc.next());
			...
			product.setProductCost(sc.nextDouble());
		...
		case 2:
			...
			for(Product product1 : productList1)
			{
				...
				System.out.print("Product Cost:"+product1.getProductCost()+"");
		...
		case 3:
			...
			for(Product product2: productList2)
			{
				...
				System.out.print("Product Cost:"+product2.getProductCost()+"");
		...
		case 4:
			...
			for(Product product3 : productList)
			{
				...
				System.out.print("Product Cost:"+product3.getProductCost()+"");
		...
		case 5:
			...
			System.out.print("Product Cost:"+product4.getProductCost()+"");
			break;
		case 6:
			...
			System.out.print("Product Cost:"+product5.getProductCost()+"");
			break;
